The codes are organized into two main folders:

- `v16.68 auto order`  
  Simulation codes for the **look direction error** scenario.

- `v16.68_coherent`  
  Simulation codes for the **coherent scattering mismatch** scenario.
...
.
├── v16.68 auto order/
│   └── Simulation codes for look direction error
│
├── v16.68_coherent/
│   └── Simulation codes for coherent scattering mismatch
│
└── README.md
